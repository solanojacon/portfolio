...
SECRET_KEY = 'django-insecure-5_7tfpd+l=a(r+h$3l8j%x_ct!&m-81tynjhea5a1tz^2pmoa5'
...
DATABASES = {
    'default': {
        ...
        'NAME': str(BASE_DIR).rsplit(os.path.sep, 2)[0] + os.path.sep + \
                str(BASE_DIR).rsplit(os.path.sep, 2)[1] + '-data' + os.path.sep + \
                str(BASE_DIR).rsplit(os.path.sep, 2)[2] + os.path.sep + \
                'db.sqlite3',
    }
}
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, 'tasks/staticfiles'),
    os.path.join(BASE_DIR, 'notes/staticfiles'),
]
